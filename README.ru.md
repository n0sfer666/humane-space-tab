...
- **Выдать Accessibility.** Приложение просит его при запуске, а его иконка в меню-баре
  ...
  спрашивает снова. Руками — **System Settings → Privacy & Security → Device Control and
  Data Access**, строка, которая на macOS 15–26 называлась **Accessibility**.
  В обоих случаях переключатель заработает за пару секунд, без
